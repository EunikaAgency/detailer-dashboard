...
function createDashboardUtilizationTeamPayload(source) {
  ...
  return {
    ...
    teamUtilization: {
      ...
      perProduct: buildTotalRows(selectedMonthEventRecords, "product", 20, { includeBrandMetadata: true }),
...
function createDashboardSummaryPayload(source) {
  ...
  return {
    ...
    legacyOverview: {
      monthly: {
        product: buildTotalRows(selectedMonthEventRecords, "product", 20, { includeBrandMetadata: true }),
        person: buildTotalRows(selectedMonthEventRecords, "psr", 20),
        team: buildTotalRows(selectedMonthEventRecords, "team", 20),
      },
      yearly: {
        product: buildTotalRows(selectedYearEventRecords, "product", 10, { includeBrandMetadata: true }),
